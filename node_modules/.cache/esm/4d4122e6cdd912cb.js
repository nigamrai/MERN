let User,refreshTokens,Joi,bcrypt,CustomErrorHandler,fs,cloudinary,jwtServices,sendEmail,crypto;_cdd‍.x([["default",()=>_cdd‍.o]]);_cdd‍.w("../models/user.model",[["default",["User"],function(v){User=v}]]);_cdd‍.w("../models/token.model",[["default",["refreshTokens"],function(v){refreshTokens=v}]]);_cdd‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_cdd‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_cdd‍.w("../services/customErrorHandler",[["default",["CustomErrorHandler"],function(v){CustomErrorHandler=v}]]);_cdd‍.w("fs/promises",[["default",["fs"],function(v){fs=v}]]);_cdd‍.w("cloudinary",[["default",["cloudinary"],function(v){cloudinary=v}]]);_cdd‍.w("../services/jwtServices",[["default",["jwtServices"],function(v){jwtServices=v}]]);_cdd‍.w("dotenv/config");_cdd‍.w("../services/sendEmail",[["default",["sendEmail"],function(v){sendEmail=v}]]);_cdd‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);
...
const userController={
    ...
    async register(req,res,next){
      ...
      _cdd‍.g.console.log("File Details>",JSON.stringify(req.file));
      _cdd‍.g.console.log(req.file.path);
      if(req.file){
        try{
    ...
    async updateUser(req,res,next){
      ...
      _cdd‍.g.console.log(fullName);
      const id=req.user._id;
      const user=await User.findById(id);
      _cdd‍.g.console.log(user);
      if(!user){
        return next(CustomErrorHandler.doesNotExist("User does not exist"));
      }
      ...
      await user.save();
      _cdd‍.g.console.log(user.fullName);
